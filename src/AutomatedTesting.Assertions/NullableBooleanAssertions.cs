...
/// <summary>
/// Assertions for nullable <see cref="bool"/>s.
/// </summary>
public sealed class NullableBooleanAssertions : IFluentInterface
{
    #region Dependencies

    /// <summary>
    /// Creates a new instance of the <see cref="NullableBooleanAssertions"/> type.
    /// </summary>
    /// <param name="nullableBoolean"> The nullable boolean to be validated. </param>
    public NullableBooleanAssertions(bool? nullableBoolean)
    {
    ...
    /// <summary>
    /// Assert that a given nullable boolean value equals an <paramref name="expected"/> value.
    /// </summary>
...
#nullable restore
    ...
    /// <summary>
    /// Assert that a given nullable boolean value equals "true".
    /// </summary>
    /// <param name="because"> A reason why this assertion needs to be correct. </param>
    /// <param name="testMethodName"> Supplied by the compiler. </param>
    /// <param name="lineNumber"> Supplied by the compiler. </param>
...
#nullable restore
    {
        if (NullableBoolean != true)
        {
            ...
            var actual = FormattableString.Invariant($"is \"{NullableBoolean}\"");
            var expectedText = "to be \"True\"";
            throw Context.GetFormattedException(testMethodName, context, actual, expectedText, because);
        }
    }

    /// <summary>
    /// Assert that a given nullable boolean value equals "false".
    /// </summary>
    /// <param name="because"> A reason why this assertion needs to be correct. </param>
    /// <param name="testMethodName"> Supplied by the compiler. </param>
    /// <param name="lineNumber"> Supplied by the compiler. </param>
...
#nullable restore
    {
        if (NullableBoolean != false)
        {
            var context = Context.GetCallerContext(testMethodName, true, sourceCodePath, lineNumber);
            var actual = FormattableString.Invariant($"is \"{NullableBoolean}\"");
            var expectedText = "to be \"False\"";
            throw Context.GetFormattedException(testMethodName, context, actual, expectedText, because);
        }
    }

    /// <summary>
    /// Assert that a given nullable boolean value is null.
    /// </summary>
    /// <param name="because"> A reason why this assertion needs to be correct. </param>
    /// <param name="testMethodName"> Supplied by the compiler. </param>
    /// <param name="lineNumber"> Supplied by the compiler. </param>
