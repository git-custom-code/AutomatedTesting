...
/// <summary>
/// Assertions for <see cref="bool"/>s.
/// </summary>
public sealed class BooleanAssertions : IFluentInterface
{
    #region Dependencies

    /// <summary>
    /// Creates a new instance of the <see cref="BooleanAssertions"/> type.
    /// </summary>
    /// <param name="boolean"> The boolean to be validated. </param>
    public BooleanAssertions(bool boolean)
    {
    ...
    /// <summary>
    /// Assert that a given boolean value equals an <paramref name="expected"/> value.
    /// </summary>
...
#nullable restore
    ...
    /// <summary>
    /// Assert that a given boolean value equals "true".
    /// </summary>
    /// <param name="because"> A reason why this assertion needs to be correct. </param>
    /// <param name="testMethodName"> Supplied by the compiler. </param>
    /// <param name="lineNumber"> Supplied by the compiler. </param>
...
#nullable restore
    ...
    /// <summary>
    /// Assert that a given boolean value equals "false".
    /// </summary>
    /// <param name="because"> A reason why this assertion needs to be correct. </param>
    /// <param name="testMethodName"> Supplied by the compiler. </param>
    /// <param name="lineNumber"> Supplied by the compiler. </param>
