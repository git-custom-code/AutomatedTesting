namespace CustomCode.AutomatedTesting.Mocks.Emitter
{
    ...
    /// ]]>
    /// </remarks>
    public sealed class DecorateFuncEmitter<T> : MethodDecoratorEmitterBase
    {
        #region Dependencies

        /// <summary>
        /// Creates a new instance of the <see cref="DecorateFuncEmitter{T}"/> type.
        /// </summary>
