...
/// <summary>
/// Default implementation of the <see cref="ICallBehavior{TMock, TResult}"/> interface.
/// </summary>
...
/// </typeparam>
public sealed class CallBehavior<TMock, TResult> : ICallBehavior<TMock, TResult>
    where TMock : class
{
    #region Dependencies

    /// <summary>
    /// Creates a new instance of the <see cref="CallBehavior{TMock, TResult}"/> type.
    /// </summary>
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> Records<T1>(out IEnumerable<T1> recordedCalls)
    {
...
#nullable restore
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> Records<T1, T2>(out IEnumerable<(T1, T2)> recordedCalls)
    {
...
#nullable restore
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> Records<T1, T2, T3>(out IEnumerable<(T1, T2, T3)> recordedCalls)
    {
...
#nullable restore
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> Records<T1, T2, T3, T4>(out IEnumerable<(T1, T2, T3, T4)> recordedCalls)
    {
...
#nullable restore
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> Records<T1, T2, T3, T4, T5>(out IEnumerable<(T1, T2, T3, T4, T5)> recordedCalls)
    {
...
#nullable restore
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> Records<T1, T2, T3, T4, T5, T6>(out IEnumerable<(T1, T2, T3, T4, T5, T6)> recordedCalls)
    {
...
#nullable restore
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> Records<T1, T2, T3, T4, T5, T6, T7>(out IEnumerable<(T1, T2, T3, T4, T5, T6, T7)> recordedCalls)
    {
...
#nullable restore
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> Records<T1, T2, T3, T4, T5, T6, T7, T8>(out IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8)> recordedCalls)
    {
...
#nullable restore
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> Records<T1, T2, T3, T4, T5, T6, T7, T8, T9>(out IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8, T9)> recordedCalls)
    {
...
#nullable restore
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> Returns(TResult returnValue)
    {
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> ReturnsOutParameterValue<T>(string outParameterName, T outParameterValue)
    {
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> ReturnsOutParameterSequence<T>(string outParameterName, params T[] outParameterSequence)
    {
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> ReturnsRefParameterValue<T>(string refParameterName, T refParameterValue)
    {
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> ReturnsRefParameterSequence<T>(string refParameterName, params T[] refParameterSequence)
    {
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> ReturnsSequence(params TResult[] returnValueSequence)
    {
    ...
    /// <inheritdoc cref="IMockBehavior{TMock}" />
    public ICallBehavior<TMock, TOtherResult> That<TOtherResult>(Expression<Func<TMock, TOtherResult>> mockedCall)
    {
        return MockBehavior.That(mockedCall);
    }
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> Throws<T>() where T : Exception, new()
    {
    ...
    /// <inheritdoc cref="ICallBehavior{TMock, TResult}" />
    public ICallBehavior<TMock, TResult> Throws(Exception exception)
    {
